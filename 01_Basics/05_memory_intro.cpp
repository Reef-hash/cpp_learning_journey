...
int main() {
    ...
    std::cout << "Player Name: " << playerName << " (Memory Adress: " << &playerName << ")" << " String size: " << sizeof(playerName) << " bytes" << std::endl;
    ...
    std::cout << "playerHealth: " << playerHealth << " (Memory Adress: " << &playerHealth << ")" << " Integer size: " << sizeof(playerHealth) << " bytes" << std::endl;
    ...
    std::cout << "Player Stamina: " << playerStamina << " (Memory Adress: " << &playerStamina << ")" << " Float size: " << sizeof(playerStamina) << " bytes" << std::endl; //dont forget semicolon at the end of the line
    std::cout << "Is Player Alive: " << std::boolalpha << isPlayerAlive << " (Memory Adress: " << &isPlayerAlive << ")" << " Boolean size: " << sizeof(isPlayerAlive) << " bytes" << std::endl;
