...
int main() {
    ...
    std::cin.ignore(); //to ignore the newline character left in the input buffer after reading age, so that it doesn't interfere with any subsequent input operations
